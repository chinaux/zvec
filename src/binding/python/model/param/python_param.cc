...
void ZVecPyParams::bind_vector_query(py::module_ &m) {
  ...
  py::class_<SubQuery>(m, "_SubQuery")
      ...
      .def_readwrite("field_name", &SubQuery::field_name_)
      .def_readwrite("query_params", &SubQuery::query_params_)
      .def_static(
          "from_vector_query",
          [](const VectorQuery &vq) {
            ...
            auto &payload = std::get<VectorQueryPayload>(sub.payload_);
            payload.query_vector_ = vq.query_vector_;
            payload.sparse_indices_ = vq.query_sparse_indices_;
            payload.sparse_values_ = vq.query_sparse_values_;
